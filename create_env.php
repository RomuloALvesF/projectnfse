...
/**
 * Script to create .env file for NFSe Project
 */
...
if (file_put_contents($envFile, $envContent)) {
    ...
    echo "\n🔧 Configuration added:\n";
    echo "   - CERTIFICATE_PASSWORD=182838\n";
    echo "   - NFSE_API_URL=https://bhissdigital.pbh.gov.br\n";
    echo "\n🚀 You can now run your NFSe API service!\n";
} else {
